...
var TestComponent = function () {
    ...
    var _a = useOptimizedFormModel_1.useOptimizedFormModel(getComment, entityTransform), comment = _a[0], onPropChange = _a[1], status = _a[2];
    var preModel = {
        Comment: '',
    };
    var _b = useSplitFormModel_1.useSplitFormModel(preModel, comment, function () { return ''; }, onPropChange, status), partialModel = _b[0], onUpdate = _b[1];
    return (React.createElement(React.Fragment, null,
        React.createElement("input", { type: "text", "data-testid": "Comment", name: "Comment", value: partialModel.Comment, onChange: onUpdate }),
        React.createElement("button", { type: "button", onClick: onSaveClick, disabled: status === FormStatus_1.FormStatus.Loading }, "Save")));
};
describe('useSplitFormModel', function () {
    beforeEach(function () {
    ...
    it('should try to load entity immediately', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest_fetch_mock_1.default.mockResponse(JSON.stringify({ Comment: '12345' }));
    ...
    it('should update values properly ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, getByText, getByTestId, commentInput, button;
