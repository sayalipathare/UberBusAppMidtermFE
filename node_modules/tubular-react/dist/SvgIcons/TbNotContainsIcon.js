...
exports.TbNotContainsIcon = void 0;
var React = require("react");
var SvgIcon_1 = require("@material-ui/core/SvgIcon");
var TbNotContainsIcon = function () {
    return (React.createElement(SvgIcon_1.default, { viewBox: "0,0,16,16" },
        ...
        React.createElement("path", { d: "M15.62,10.71a2.74,2.74,0,0,1-1.43.36,2.33,2.33,0,0,1-1.79-.73,2.62,2.62,0,0,1-.68-1.87,2.87,2.87,0,0,1,.73-2.06,2.58,2.58,0,0,1,2-.78,2.73,2.73,0,0,1,1.21.25v.85a2.13,2.13,0,0,0-1.24-.4,1.68,1.68,0,0,0-1.31.57,2.16,2.16,0,0,0-.51,1.5,2.05,2.05,0,0,0,.48,1.44,1.67,1.67,0,0,0,1.29.53,2.1,2.1,0,0,0,1.28-.45Z" }),
        React.createElement("path", { fill: "white", d: "M4.78,8.74V8.22h6.44v.52Z" })));
};
exports.TbNotContainsIcon = TbNotContainsIcon;
